...
import { NavController, NavParams, IonicPage,App, ViewController, Events} from 'ionic-angular';
...
export class LoginPage{
  ...
  /* DMAApp Storage  ionViewDidLoad is similar to onInit*/
  ionViewDidLoad(){
  ...
  DMAAppAuth() {
    ...
    browser.on('loadstop').subscribe((data) => {
      console.log(data.url.split(this.tokenURLFormat)[1], 'token');
